...
function WorkItems({ data, projectId, act }) {
  const [form, setForm] = useState({ project_id: projectId, item_type: itemTypes[data.portal_user.user_type]?.[0] || '', title: '', description: '', file: null })
